...
if __name__ == "__main__":
    ...
    print(b.classify('I love dogs! Theyre so fluffy and cute!'))
    print(b.classify('I love the band Neon Trees! My favorite song is Animal!'))
    print(b.classify('My favorite sport is hockey. The sport is fun to watch!'))

    print(b.classify('The solar eclipse is going to be boring, why should we waste our time?'))
    print(b.classify('I hate dogs! They shed hair everywhere and are annoying'))
    print(b.classify('I hate drake! His music is bland and untasteful!'))
    print(b.classify('I hate soccer! Its boring to watch and people fake injuries'))

    print(b.classify('Wow! This movie is the reason why I love cinema. I never read the books but did small research about them.The books have so much information in it, however, Denis Villeneuve was able to stay true to the source material. The background information of this world is skillfully explained in the movie so casuals can understand. The visuals in this movie are stunning. The details in the architecture, wardrobe, and equipment makes this world feel alive. In fact, while watching this movie, i felt like i was indeed in this book and going along this journey. The use of colors amplify the movie and the score gives you a calming sensation like you are indeed walking on the sand and spices of Arrakis. You can tell that Denis Villeneuve put his heart and soul into this movie. For the actors, this is all of their best work yet, an although Zendaya plays a small role in the movie, she really shines in it. Lady Jessica played by Rebecca Ferguson is by far my favorite character in this movie. The power she has when on screen is unbelievable.'))
    print(b.classify('Absolute Masterpiece! Literally whole run time I never felt necessary to blink! Each and every Frame was Out of the world combined with the exhilarating music its a treat! The pacing at start was bit slow although the setup and world building is legendary once the 2nd half kick in this movie is literally Mind-blowing! The SciFi elements were awesome and the acting was mesmerizing,the story was amazing and the direction is legendary The whole politics and houses things were  engaging and the action scenes it was eye candy. The desert worm scenes,the war scene and the Pauls dads death scene was amazing as hell and the ladies entry before Pauls hand dream thing that music is literally chilling I had goosebumps The extraordinary powers were not that focused but the visions were engaging the the ending was quite unexpecting I thought it would end with something it felt like why I want it more and its keeping the hype for 2nd part. The whole movie was breathtakingly Amazing Imax Is The best way have treat of this masterpiece'))
    print(b.classify('Scify film that rips off every popular scify TV show and movie since the 60s and puts them all in the blender for this unoriginal film. Issac was only added because of how much star wars is ripped off here to try to hedge the studios bets on being sued. Skarsgård and Dastmalchian are just Jabba and his assistant, timothy is luke skywalker, momma is han solo, Zendaya is Princess Leia with terrible dark blue contacts that are the same shade as a pepsi can, Javier being every leader of a tribe ever, everyone else is just genric characters youve seen in a million movies like this before for 48 years straight. The new stuff isnt that great too like holographic laser tag sword fighting, dragonfly space ships, spice turning peoples eyes blue, VR headsets, dragonfly drones, giant bugs, pain boxes with poison needles, levitating skarsgård, sand worms, buried soldiers that sneak up on the soldiers standing on them, obvious foreshadowing that makes kids movie foreshadowing look epic in comparison, spitting as a sign of trust, peri compass, a suit that turns sweat into drinking water and cooling thats powered by movement, drones looking for worms due to shields attracting the worms, oil baths, bleeding water, spit pumps, poison gas exhale. Also their ADR is put in random spots with Subtitles even coming up for peoples thoughts. Overall a skippable, genric, and boring sci fy movie that has an ending of the main character joining with the tribe to kill Skarsgård after killing one of the tribesmen in a duel then it ends abruptly.'))
    print(b.classify('Yet another watered version of the already watered down late Star Wars saga, now even more shamefully targeted to the teen public, coated with great scenes, great performances and top celebs. The protagonist depicts once again the typical frail and introspective teenager whose deeper egoistic dream is to be the center of the universe, full of power, glory and in a reality where adults are basically stupid, nuisances or stereotypical buffoons. For me this type of story just keeps cashing in over this teens distortion of reality, furthering the damage that media has been done to society over the last half century. By making young adults keep thinking they are inherently special and smarter than adults, they will secretly expecting to be discovered. This goes on till they are no longer young. As nothing of special happens in their lives, they feel betrayed, turn into bitter and depressed adults, and so easy targets of other industries such as tobacco, alcohol, processed food, drugs, entertainment, eventually becoming actual stereotypical buffoons for the next generation.'))
